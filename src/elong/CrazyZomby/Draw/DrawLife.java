...
public class DrawLife {
    ...
    private void initVertexBuffer(int col)
    {
    	...
    	int w = 16*CrazyZombyConstent.ADP_SIZE;
    	int h = 16*CrazyZombyConstent.ADP_SIZE;
    ...
    {
        vCount=6;//顶点的数量，一个正方形用两个三角形表示，共需要6个顶点
        float deltaX = 32*5*CrazyZombyConstent.ADP_SIZE;
        float deltaY = 64*5*CrazyZombyConstent.ADP_SIZE;
        int vertices[]=new int[]//顶点坐标数据数组
        {
