...
public class DrawTimeBar {
    ...
    private void initVertexBuffer(float percent)
    {
        ...
        float deltaX = 2*w*CrazyZombyConstent.ADP_SIZE * percent;
        float deltaY = -64 * 4.5f * CrazyZombyConstent.ADP_SIZE;
        int vertices[]=new int[]//顶点坐标数据数组
        {
           	(int)(-w*CrazyZombyConstent.ADP_SIZE),h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	(int)(-w*CrazyZombyConstent.ADP_SIZE),-h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	(int)(-w*CrazyZombyConstent.ADP_SIZE+deltaX),-h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	(int)(-w*CrazyZombyConstent.ADP_SIZE+deltaX),-h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	(int)(-w*CrazyZombyConstent.ADP_SIZE+deltaX),h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	(int)(-w*CrazyZombyConstent.ADP_SIZE),h*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0
        };
    ...
    {
        vCount=6;//顶点的数量，一个正方形用两个三角形表示，共需要6个顶点
        float deltaX = 0*CrazyZombyConstent.ADP_SIZE;
        float deltaY = -64 * 4.5f *CrazyZombyConstent.ADP_SIZE;
        int vertices[]=new int[]//顶点坐标数据数组
        {
           	-mBitmapW/2*CrazyZombyConstent.ADP_SIZE+(int)deltaX,mBitmapH/2*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	-mBitmapW/2*CrazyZombyConstent.ADP_SIZE+(int)deltaX,-mBitmapH/2*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	mBitmapW/2*CrazyZombyConstent.ADP_SIZE+(int)deltaX,-mBitmapH/2*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	mBitmapW/2*CrazyZombyConstent.ADP_SIZE+(int)deltaX,-mBitmapH/2*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
        	mBitmapW/2*CrazyZombyConstent.ADP_SIZE+(int)deltaX,mBitmapH/2*CrazyZombyConstent.ADP_SIZE+(int)deltaY,0,
