...
public class DrawResultScore {
    ...
    public DrawResultScore(int textureId)
    {
    	this.textureId=textureId;
    	
    	control = new CtlResultScore();
    }	
	//顶点坐标数据的初始化
    private void initVertexBuffer(int col)
    {
    	    	
    	int w = 12*CrazyZombyConstent.ADP_SIZE;
    	int h = 24*CrazyZombyConstent.ADP_SIZE;
        int deltaX = (int)((col-4.5)*2*w);
        int deltaY = (int)(-0.75*2*h);
    ...
    {
    	CtlResultScore ctl = (CtlResultScore)control;
    	int score = ctl.getNumber();
