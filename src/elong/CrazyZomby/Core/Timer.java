...
public class Timer {
	...
	void addTime()
	{
		mUsedTime -= CrazyZombyConstent.TIME_ADD;
		if(mUsedTime < 0) mUsedTime = 0;
		mStartTime = System.currentTimeMillis()/1000 - mUsedTime;		
	}

	void delTime()
	{
		mUsedTime += CrazyZombyConstent.TIME_DEL;
		if(mUsedTime > CrazyZombyConstent.MAX_TIME) mUsedTime = CrazyZombyConstent.MAX_TIME;
		mStartTime = System.currentTimeMillis()/1000 - mUsedTime;		
	}
}
